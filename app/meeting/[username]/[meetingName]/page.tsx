...
async function getData(userName, meetingName) {
  const data = await prisma.user.findUnique({
    ...
    select: {
      ...
      Availability: true,
      EventType: {
        where: { user: { username: userName }, url: meetingName },
      },
    },
  });
...
const MeetingPagee = async ({ params, searchParams }) => {
        ...
        <Card>
          <CardContent className="p-5 grid md:grid-cols-[1fr,auto,1fr] gap-4">
            <div>
              ...
              Oficina de Design</h1>
              <p className="text-sm font-medium text-[#374151]">
                
                Um bate-papo mais longo para discutir design.
              </p>
