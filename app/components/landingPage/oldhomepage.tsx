  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
      <nav className="flex items-center w-full  py-5 justify-between">
        ...
        <Button asChild>
          <Link href="/api/auth">Comece Hoje</Link>
        </Button>
      </nav>
      ...
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
            Agendamento facilitado <span className="text-blue-600">sUPER fÁCIL</span>
          </h1>
          <p className="mt-3 text-lg text-gray-800 dark:text-neutral-400">
          Conheça o Calendar, o planejador de agendamentos para todos. Foque
          em suas reuniões, não no agendamento delas. Gratuito para indivíduos.
          </p>
          {/* Buttons */}
